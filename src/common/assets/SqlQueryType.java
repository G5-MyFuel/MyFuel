...
public enum SqlQueryType {
    ...
    //fast fuel :
    GET_OWNER_DETAILS(SqlExecutionType.EXECUTE_QUERY),
    GET_VEHICLE_DETAILS(SqlExecutionType.EXECUTE_QUERY),
    GET_ALL_STATIONS(SqlExecutionType.EXECUTE_QUERY),
    UPDATE_FUEL_INVENTORY(SqlExecutionType.UPDATE_QUERY),
    INSERT_NEW_ORDERFORSTOCK(SqlExecutionType.UPDATE_QUERY),
